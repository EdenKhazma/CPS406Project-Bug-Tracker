...
//Main is for GUI purposes, it will be used to test the functionality of the code and to show how the code works.
// It will not be used in the final product, but it will be used to test the code and to show how the code works.
public class Main {
